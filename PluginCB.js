...
function changePanel() {
    return goalReached ? (row1 = "Goal Reached - Thanks all.", row2 = "", row3 = "Mvp - " + cut(mvpName) + " (" + mvpSum + ")", cb["drawPanel"]()) : goalOn ? "COUNTER" == goalMode ? (goalSum ? (row1 = x(usrNb, "Pleaser$") + (tokenOn ? " - " + x(goalSum, "Token$ Received") : ""), row2 = "Mvp - " + cut(mvpName) + " - " + mvpSum, row3 = "Newest - " + cut(lastTipper) + " - " + lastTip) : (row1 = "My Vibrator reacts to your Tips", row2 = "Start Playing", row3 = ""), cb["drawPanel"]()) : "MULTI" == goalMode ? (row1 = "Goal #" + (goalNb + 1) + " : " + (setRemaining - remaining) + " / " + setRemaining + " [ " + remaining + " Remaining ]" + (tokenOn && goalNb >= 1 ? " (" + goalSum + ")" : ""), goalSum ? (row2 = "Mvp - " + cut(mvpName) + " - " + mvpSum, row3 = "Newest - " + cut(lastTipper) + " - " + lastTip) : (row2 = "My Vibrator reacts to your Tips", row3 = "Start Playing"), cb["drawPanel"]()) : "SINGLE" == goalMode ? (row1 = tokenOn ? "Goal - " + goalSum + " / " + setRemaining + " [ " + remaining + " Remaining ]" : "Goal Remaining [ " + remaining + _0x2ac8[63], goalSum ? (row2 = "Mvp - " + cut(mvpName) + " - " + mvpSum, row3 = "Newest - " + cut(lastTipper) + " - " + lastTip) : (row2 = "My Vibrator reacts to your Tips", row3 = "Start Playing"), cb["drawPanel"]()) : void(0) : cb["drawPanel"]()
}
...
cb.settings_choices = [{
    ...
    maxLength: 150,
    required: !0,
    defaultValue: "WeVibe, the vibrator that reacts to your Tips!"
}, {
    name: "tags",
    label: "Tags (#) ",
    type: "str",
    ...
    name: "levelMode",
    label: "- Notification of WeVibe-Levels",
    type: "choice",
    ...
    maxLength: 10240,
    required: !0,
    defaultValue: "MY WEVIBE IS SET TO REACT TO YOUR TIPS. THERE ARE 5 LEVELS OF INTENSITY, HIGHER TIPS MEAN MORE INTENSITY!"
}, {
    name: "level1",
    label: "Level 1 ",
    type: "str",
    ...
    maxLength: 10240,
    required: !1,
    defaultValue: "WeVibe : Device that vibrates and rotates on your Tips!"
}, {
    name: "notice2",
    label: "Notice 2 ",
    type: "str",
    ...
    maxLength: 10240,
    required: !1,
    defaultValue:" :WeVibe Give me pleasure with your tips!"
}, {
    name: "notice3",
    label: "Notice 3 ",
    type: "str",
